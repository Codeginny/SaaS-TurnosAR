  ...
  return (
    <div className="p-8 w-full bg-gray-50 dark:bg-slate-900 min-h-screen">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-blue-700 dark:text-blue-400 mb-2">Direcciones</h1>
          <p className="text-gray-600 dark:text-gray-300">Gestioná los lugares donde atendés a tus pacientes</p>
        </div>
