  ...
  return (
    <div className="p-8 w-full bg-gray-50 dark:bg-slate-900 min-h-screen">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-blue-700 dark:text-blue-400 mb-2">Bancos</h1>
          <p className="text-gray-600 dark:text-gray-300">Gestioná tus cuentas bancarias para recibir pagos de pacientes</p>
        </div>
          ...
          <div className="mb-8 bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">CBU</label>
                  <input
                    type="text"
                    name="cbu"
                    value={form.cbu}
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Alias</label>
                  <input
                    type="text"
                    name="alias"
                    value={form.alias}
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {banks.map((bank) => (
            <div key={bank.id} className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-6">
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-gray-100">{bank.banco}</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-300">{bank.tipoCuenta}</p>
                  </div>
                </div>
        ...
        {banks.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-4">Agregá tu primera cuenta bancaria para recibir pagos de pacientes</p>
            <button
              onClick={() => setShowAddForm(true)}
